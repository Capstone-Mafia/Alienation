...
public class South implements Action {

    private static final ArrayList<String> performAction = new ArrayList<>();

    static {
        try {
            try (InputStream inputStream = Look.class.getResourceAsStream("/southSyns.txt");
...
//                    "inputsynonyms" + File.separator + "southSyns.txt";
//
